...
describe(
  ...
  () => {
    ...
    it(
      'should upload and get image details',
      async () => {
        const sut = makeSut()
        const image = await sut.uploadImageURL({
          imageURL: testImageURL,
    ...
    it(
      'should upload and get base image',
      async () => {
        const sut = makeSut()
        const image = await sut.uploadImageURL({
          imageURL: testImageURL,
    ...
    it(
      'should get direct upload url v2',
      async () => {
        const sut = makeSut()
    ...
    it(
      'should upload image with buffer',
      async () => {
        const sut = makeSut()
    ...
    it(
      'should upload image with base64',
      async () => {
        const sut = makeSut()
        const image = await sut.uploadImage({
          name: 'test-image.jpg',
    ...
    it(
      'should upload and delete images with metadata test',
      async () => {
        const sut = makeSut()
        const image = await sut.uploadImageURL({
          imageURL: testImageURL,
